...
/*  setTimeout(function () {
    if (window.___browserSync___ === undefined && Number(localStorage.getItem('SpiderQAMS:Demo:MessageShowed')) < Date.now()) {
      localStorage.setItem('SpiderQAMS:Demo:MessageShowed', (Date.now()) + (15 * 60 * 1000))
      // eslint-disable-next-line no-alert
      alert('You load SpiderQAMS\'s "demo.js", \nthis file is only created for testing purposes!')
    }
  }, 1000)*/
  ...
  $container.append(
    '<h5>Customize SpiderQAMS</h5><hr class="mb-2"/>'
  )
